            ...
            <div class="col-11">
              <div class="card bg-success text-white mb-3">
                <div class="card-body p-4 ">
                  <p class="card-text"><i class="bx bx-chevron-right"></i><b class="underline"><u>{{item.qty}}</u></b> {{ item.indicator }}</p>
                </div>
              </div>
            </div>
            <div class="col-1">
          ...
          <div class="table-responsive text-nowrap">
            <table class="table table-striped table-hover">
              ...
              <tr class="table-success">
                  <th colSpan="4"><i class="bx bx-chevron-right"></i><b><u>{{data.qty}}</u></b> {{data.stIndicator}}</th>
                </tr>
                <tr>
